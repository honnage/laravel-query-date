...
class CreateTableHistoryReportDetails202110 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_report_details_2021_10', function (Blueprint $table) {
              // $table->id();
          $table->string('phone');
          $table->string('branch');
    ...
    {
        Schema::dropIfExists('history_report_details_2021_10');
    }
}
