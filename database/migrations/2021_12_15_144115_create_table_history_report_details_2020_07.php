...
class CreateTableHistoryReportDetails202007 extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('history_report_details_2020_07', function (Blueprint $table) {
           // $table->id();
           $table->string('phone');
           $table->string('branch');
    ...
    {
        Schema::dropIfExists('report_details_2020_07');
    }
}
